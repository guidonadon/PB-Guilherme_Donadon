...
![Gráfico Apps Mais Baixados](../Evidencias/top5_apps.png) 
...
![Gráfico Apps Mais Baixados](../Evidencias/cod_graf_pizza.png) 
...
![Apps que mais arrecadaram](../Evidencias/cod_apps_mais_arrec.png) 
...
![Grafico Arrecadação apps](../Evidencias/grafico3.png) 
...
![Faixa de avaliação](../Evidencias/cod_faixa_review.png) 
...
![Grafico Arrecadação apps](../Evidencias/grafico4.png) 

### 6. Resultados
  ##### Etapa 2 - Gráfico de Colunas
  ![Grafico Arrecadação apps](../Evidencias/grafico1.png) 

  ##### Etapa 3 - Gráfico de Pizza
  ![Grafico Arrecadação apps](../Evidencias/grafico2.png) 

  ##### Etapa 4 - Aplicativo mais Caro
  ![Grafico Arrecadação apps](../Evidencias/result_appcaro.png) 
  
  ##### Etapa 5 - Aplicativos para Mature 17+
  ![Grafico Arrecadação apps](../Evidencias/result_mature.png) 
