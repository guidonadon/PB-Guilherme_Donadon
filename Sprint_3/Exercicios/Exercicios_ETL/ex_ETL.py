...
for coluna in amostra[1:]:
    ...
    with open('Etapa-2.txt', 'w', encoding='utf-8') as resultado:
        ...
        resultado.write(f'\n Média de receita de {n_filmes} filmes: {receita_media}')
...
with open('Etapa-3.txt', 'w', encoding='utf-8') as resultado:
    resultado.write(f'Ator/Atriz com maior média de faturamento: {ator} possui média de faturamento bruto: {maior_media:.2f}\n')
